        ...
        <div className="min-h-screen flex items-center justify-center pt-5 p-4 xs:p-6 sm:p-8">
            <div className="bg-white/80 backdrop-blur-md rounded-lg p-4 xs:p-6 sm:p-8 w-full max-w-2xl sm:max-w-3xl md:max-w-4xl shadow-lg">
                ...
                <form onSubmit={handleSubmit( onSubmit )} className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        <label htmlFor="name" className="block text-gray-800 text-sm sm:text-base mb-1">
                            Name of Bed Space
                        </label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label htmlFor="location" className="block text-gray-800 text-sm sm:text-base mb-1">
                            Location
                        </label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label htmlFor="price" className="block text-gray-800 text-sm sm:text-base mb-1">
                            Price (per month)
                        </label>
                        <input
                            type="number"
                        ...
                        />
                        {errors.price && <p className="text-red-500 text-xs sm:text-sm mt-1">{errors.price.message}</p>}
                    </div>
                    <div>
                        <label htmlFor="whatsapp" className="block text-gray-800 text-sm sm:text-base mb-1">
                            WhatsApp Number
                        </label>
                        <input
                            type="text"
                    ...
                    <div className="md:col-span-2">
                        <label htmlFor="description" className="block text-gray-800 text-sm sm:text-base mb-1">
                            Description
                        </label>
                        <textarea
                            id="description"
